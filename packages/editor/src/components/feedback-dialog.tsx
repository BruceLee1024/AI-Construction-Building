      ...
      <Dialog onOpenChange={handleClose} open={open}>
        ...
        >
          ...
          {isDragging && (
            <div className="absolute inset-0 z-50 flex items-center justify-center rounded-lg border-2 border-primary/50 border-dashed bg-primary/5 backdrop-blur-sm transition-all">
              <div className="flex flex-col items-center gap-2 text-primary/70">
                ...
                <p className="font-medium text-sm">{t('feedback.dropImages')}</p>
              </div>
            </div>
          )}
          ...
          <DialogHeader>
            ...
            <DialogDescription>{t('feedback.loveToHear')}</DialogDescription>
          </DialogHeader>
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between">
                ...
                >
                  ...
                  {images.length > 0 ? `${images.length}/${MAX_IMAGES}` : t('feedback.attach')}
                </button>
                <input
                  accept="image/*"
                  className="hidden"
