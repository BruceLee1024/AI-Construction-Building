...
export function SettingsPanel({
  ...
  return (
    <div className="flex flex-col gap-6 p-3">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-muted-foreground text-xs">
                {projectVisibility?.isPrivate ? t('settings.publicDesc.onlyYou') : t('settings.publicDesc.anyone')}
              </div>
            </div>
            <Switch
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-muted-foreground text-xs">{t('settings.visibleToPublic')}</div>
            </div>
            <Switch
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-muted-foreground text-xs">{t('settings.visibleInEditor')}</div>
            </div>
            <Switch
      ...
      {/* Language Section */}
      <div className="space-y-2">
        <label className="font-medium text-muted-foreground text-xs uppercase">{t('common.language')}</label>
